...
const labelClass = "text-xs font-mono text-muted-foreground/70"
    ...
    <>
      ...
      {timerActive && (
        ...
        >
          ...
          <div className="flex flex-col min-w-0">
            <span className="text-[10px] font-mono text-muted-foreground/70 leading-none mb-0.5 hidden sm:block">
              interview mode
            </span>
          ...
          <button
            onClick={stopTimer}
            className="flex-shrink-0 w-5 h-5 flex items-center justify-center rounded-full hover:bg-muted text-muted-foreground/70 hover:text-foreground transition-colors"
      ...
      <section className="mt-10 space-y-5">
        ...
        <div className="rounded-xl border border-border bg-white p-6">
                ...
                <div key={i}>
                  {i < hintsUnlocked ? (
                    <div className="rounded-lg bg-muted p-3 border-l-2 border-primary">
                      <span className="text-xs font-mono text-muted-foreground/70 block mb-1">
                        hint {i + 1}
                      </span>
                    ...
                    <Button
                      variant="outline"
                      className="w-full border-dashed border-border/80 text-muted-foreground hover:border-primary hover:text-foreground text-sm"
                      onClick={() => {
            ...
            <div className="mt-4 space-y-3">
              {!showQuickCheck ? (
                ...
                <div className="rounded-xl border-2 border-primary bg-background p-4">
                  <p className="text-xs font-mono text-muted-foreground/70 mb-1">{"// quick check"}</p>
              ...
              {!showQuickCheck && (
                <Button
                  variant="outline"
                  className="w-full border-dashed border-border/80 text-muted-foreground/70 hover:border-primary hover:text-muted-foreground text-sm"
                  onClick={() => { setShowApproach(true); setShowPattern(true) }}
                >
          ...
          {hintsUnlocked === 0 && (
            <p className="text-xs text-muted-foreground/70 font-mono mt-3 text-center">
              ...
              {isPaid ? (
                <div>
                    ...
                    <div className="bg-muted rounded-lg p-3">
                      <p className="text-xs font-mono text-muted-foreground/70 mb-1">the aha moment</p>
                  ...
                  <div className="flex-1">
                    <p className="text-xs text-muted-foreground/70 font-mono mb-2">why this pattern fits</p>
        ...
        <div className="rounded-xl border border-border bg-white p-6">
          ...
          <div className="flex items-center gap-3 mt-4">
            <p className="text-xs font-mono text-muted-foreground/70">time to solve</p>
            ...
            {(result.similar_problems || []).map((p, i) => (
              ...
              >
                ...
                <div className="mt-1 flex items-center gap-2 mb-2">
                  ...
                  <span className="text-xs text-muted-foreground/70">{p.platform}</span>
                </div>
                {isPaid ? (
                  <p className="text-xs text-muted-foreground/70 leading-relaxed">{p.why_similar}</p>
                ) : (
                  <p className="text-xs text-muted-foreground/70">🔒 Upgrade to see why</p>
                )}
              </button>
            ))}
          </div>
              ...
              <div className="bg-muted rounded-lg p-5 min-h-[140px]">
                ...
                {!showAnswer ? (
                  ...
                  <div className="border-t border-border/80 pt-3 mt-2">
                    <p className="text-xs font-mono text-muted-foreground/70 mb-1">Answer:</p>
